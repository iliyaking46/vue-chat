    ...
    <div class="centered-container">
        <md-content class="md-elevation-3">
            ...
            <div class="title">
                ...
                <div class="md-title">Welcome to Chat Room</div>
                <div class="md-body-1">Add login to start, but be carefully - it's a public chat</div>
            </div>

            <div class="form">
                <md-field>
                    <label>Login</label>
                    <md-input v-model="login" autofocus @keyup.enter="auth"></md-input>
                </md-field>
            </div>
  ...
  methods: {
    auth() {
      ...
      // setTimeout(() => {
        this.loading = false;
        setUser(this.login);
        this.$emit("set-login", this.login);
      // }, 2000);
    }
  }
};
